...
- **PLATFORM-INJECTED ELEMENTS**: The platform injects calendar buttons (.cal-btn, .cal-apple, .cal-google, .cal-outlook), event recap (.thankyou-event-recap), CTA (.thankyou-cta-section, .thankyou-cta-btn), and footer (.thankyou-footer) after your HTML. Style these in theme_css to match the invite. Use ONE consistent button color (not 3 different colors). On dark backgrounds use glassmorphic buttons (rgba(255,255,255,0.12) + border:1px solid rgba(255,255,255,0.25)) and light text. On light backgrounds use your primary/accent color.
